...
# Select data
#Question1 List all the information in Department
query = """
    SELECT *
    FROM Department;
    """
cursor.execute(query)
#Question2 List all the information in Major
query = """
    SELECT *
    FROM Major;
    """
cursor.execute(query)
#Question3 List all the information in Student
query = """
    SELECT *
    FROM Student;
    """
cursor.execute(query)
#Question4 List all the information in Event
query = """
    SELECT *
    FROM Event;
    """
cursor.execute(query)
#Question5 List all the information in Event_Student
query = """
    SELECT *
    FROM Event_Student;
    """
