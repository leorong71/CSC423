...
Original file is located at
    https://colab.research.google.com/drive/11uKm4yqgWDBtE8W3NB8Wg-_JUb_yPECo
"""
...
query = """
    INSERT INTO Event
    VALUES (1, 'A', '2021-12-10', '2021-12-11');
    """
cursor.execute(query)
query = """
    INSERT INTO Event
    VALUES (2, 'B', '2021-12-10', '2021-12-11');
    """
cursor.execute(query)
query = """
    INSERT INTO Event
    VALUES (3, 'C', '2021-12-10', '2021-12-11');
    """
cursor.execute(query)
query = """
    INSERT INTO Event
    VALUES (4, 'D', '2021-12-10', '2021-12-11');
    """
cursor.execute(query)
query = """
    INSERT INTO Event
    VALUES (5, 'E', '2021-12-10', '2021-12-11');
    """
cursor.execute(query)
...
query = """
    ...
    """
cursor.execute(query)
Event_id = [row[0] for row in cursor.description]
table_data = cursor.fetchall()
df = pd.DataFrame(table_data, columns=Event_id)
# Examine dataframe
print('Question1 1.	List the event_id of the event hosted by the Adepartment.')
print(df)
print(df.columns)
print('')
query = """
...
df = pd.DataFrame(table_data, columns=Event_id)
# Examine dataframe
print('Question2 2.	List all the detail of the event hosted by Bdepartment or Cdepartment.')
print(df)
print(df.columns)
print('')
query = """
    SELECT s.*
    FROM Event_Detail d, Event_Student e, Student s
...
df = pd.DataFrame(table_data, columns=Event_id)
# Examine dataframe
print('Question3 3.	List all the detail of the students attended the event hosted by Ddepartment.')
print(df)
print(df.columns)
print('')
query = """
    ...
    """
cursor.execute(query)
Major_name = [row[0] for row in cursor.description]
table_data = cursor.fetchall()
df = pd.DataFrame(table_data, columns=Major_name)
# Examine dataframe
print('Question4 4.	List all the majors in the EDepartment.')
print(df)
print(df.columns)
print('')
...
df = pd.DataFrame(table_data, columns=Event_id)
# Examine dataframe
print('Question5 5.	List the end date of events which the students whose major are in Adepartment attended.')
print(df)
print(df.columns)
db_connect.close()